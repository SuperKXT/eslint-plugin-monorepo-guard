...
export default defineConfig([
...

	{
		...
		rules: {
			...
			// RuleTester registers tests synchronously at describe scope — hooks are
			// unavoidable in this pattern and no-hooks contradicts require-hook.
			"vitest/no-hooks": "off",
			"vitest/require-hook": "off",
			// vi.fn() types are inferred from the mock factory — explicit params add noise.
